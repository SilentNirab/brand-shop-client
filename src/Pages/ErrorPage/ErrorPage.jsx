...
import Errorbg from "../../assets/images/error.png"
const ErrorPage = () => {
    return (
        <div>
            <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
                <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
                    ...
                    <Link to={'/'}>
                        <button href="#" className="flex items-center space-x-2 bg-red-600 hover:bg-red-700 text-gray-100 px-4 py-2 rounded transition duration-150" title="Return Home">
                ...
                <div className="w-1/2 lg:h-full flex flex-col lg:items-center justify-center p-4">
                    <img src={Errorbg} alt="Error" />
                    <p className="text-6xl text-red-600 font-semibold">OOOPPS...</p>
                </div>
            </div>
        </div>
    );
